...
The IMES program also draws on the European Commission's sustainability
competence framework,
\href{https://joint-research-centre.ec.europa.eu/greencomp-european-sustainability-competence-framework_en}{GreenComp},
which defines key competences for lifelong learning and action in
sustainability. GreenComp's four competence areas --- embodying
sustainability values, embracing complexity, envisioning sustainable
futures, and acting for sustainability --- offer a guiding reference for
developing the knowledge, skills, and attitudes needed to shape just and
...
Specialisation Modules (see \textbf{?@sec-concepts}). A detailed
...
Systems \\
Sustainability & 6 & E & AM & 1 & Societies, Education, and Ethics \\
...
\addcontentsline{toc}{chapter}{Sustainability}

\markboth{Sustainability}{Sustainability}
...
This module introduces students to key concepts, historical
developments, and contested perspectives surrounding sustainability and
sustainable development. It examines the relationship between
sustainability as a normative goal and development as a process,
highlighting how environmental, social, economic, and political
dimensions intersect in both academic debates and global policy agendas.

Students engage with core sustainability challenges such as climate
change, environmental degradation, urbanization, inequality, and
biodiversity loss. They critically explore frameworks like planetary
boundaries, ecosystem services, and the Sustainable Development Goals
(SDGs), and consider tools such as Education for Sustainable Development
(ESD) and systems thinking to support transformative change.

The module also draws on the European Sustainability Competence
Framework (GreenComp), which provides a structured reference for
developing values-based, systems-aware, and action-oriented competences.
These foundations prepare students to assess sustainability issues
across scales and disciplines, and to engage thoughtfully with current
and future sustainability transitions.
...
\tightlist
\item
  Explore the foundational concepts of sustainability, sustainable
  development, including its pillars, challenges, and global frameworks
  like Agenda 21 and the SDGs.
\item
...
\tightlist
\item
  Understand the foundational principles of sustainability and
  sustainable development, including its pillars, challenges, and key
  global frameworks such as Agenda 21 and the SDGs.
\item
...
\item
  ...
  sustainability transitions at global (literature) and local levels
  (during fieldwork).
\item
  Examine the role of Education for Sustainable Action (ESA) in
...
\subsection*{a) Seminar: Sustainability}\label{a-seminar-sustainability}
\addcontentsline{toc}{subsection}{a) Seminar: Sustainability}

\subsubsection*{1. Foundations and
Frameworks}\label{foundations-and-frameworks}
\addcontentsline{toc}{subsubsection}{1. Foundations and Frameworks}

\begin{itemize}
\tightlist
\item
  Basic concepts of sustainability and its relation to sustainable
  development\\
\item
  Pillars of sustainable development: economic, social, environmental,
  political (governance)\\
\item
  Timeline of sustainability thinking: Agenda 21, Millennium Development
...
\subsubsection*{2. Conceptual Tools}\label{conceptual-tools}
\addcontentsline{toc}{subsubsection}{2. Conceptual Tools}
...
\subsubsection*{3. Global and Local Sustainability
Challenges}\label{global-and-local-sustainability-challenges}
\addcontentsline{toc}{subsubsection}{3. Global and Local Sustainability
Challenges}
...
\begin{quote}
\emph{The seminar reflects key dimensions of the GreenComp framework,
supporting the development of competences in systems thinking, critical
reflection, and values-based sustainability action.}
\end{quote}
...
\tightlist
\item
  Visit and critical observation of selected sustainability or
  transformation projects in a local or regional context (e.g.~renewable
  energy, urban agriculture or post-mining landscapes)\\
\item
  Connection of theoretical knowledge with real-world examples of
  sustainability action\\
\item
  Development of a matrix for analysing sustainability projects using
  qualitative and quantitative indicators\\
\item
  Reflection on visited projects using the developed matrix as a guiding
  tool
\end{itemize}
...
\item
  Examine how environmental challenges are addressed through domestic
  and international legal mechanisms.
\item
  Develop an understanding how law can guide the development of social
  competencies, such as green competencies.
\item
